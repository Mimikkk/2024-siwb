...
if __name__ == '__main__':
    ...
    if args.alg == 'fedavg':
        ...
        for round in range(args.comm_round):
            ...
            results.append(dict(idx=round, te_acc=test_acc, tr_acc=train_acc, tr_gmean=train_gmean, te_gmean=test_gmean))
    ...
    out_name = "logs/experiment-"+args.partition+"-"+args.alg 
